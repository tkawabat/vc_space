...
class _$_UserEntity implements _UserEntity {
  ...
  @override
  String toString() {
    return 'UserEntity(id: $id, name: $name, photo: $photo, tags: $tags, twitterId: $twitterId)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, name, photo,
      const DeepCollectionEquality().hash(_tags), twitterId);
...
abstract class _UserEntity implements UserEntity {
  const factory _UserEntity(
      ...
      required final List<String> tags,
      required final String twitterId}) = _$_UserEntity;
